...
class	btIDebugDraw
{
	...
	virtual void drawTransform(const btTransform& transform, btScalar orthoLen)
	{
		...
		drawLine( start, start + transform.getBasis( ) * btVector3( btScalar( orthoLen ), btScalar( 0 ), btScalar( 0 ) ), btVector3( btScalar( 1.f ), btScalar( 0.3 ), btScalar( 0.3 ) ) );
		drawLine( start, start + transform.getBasis( ) * btVector3( btScalar( 0 ), btScalar( orthoLen ), btScalar( 0 ) ), btVector3( btScalar( 0.3 ), btScalar( 1.f ), btScalar( 0.3 ) ) );
		drawLine( start, start + transform.getBasis( ) * btVector3( btScalar( 0 ), btScalar( 0 ), btScalar( orthoLen ) ), btVector3( btScalar( 0.3 ), btScalar( 0.3 ), btScalar( 1.f ) ) );
	}
